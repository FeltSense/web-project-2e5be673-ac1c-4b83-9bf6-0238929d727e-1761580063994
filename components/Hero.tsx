export default function Hero() {
  return (
    <section className="relative bg-gradient-to-br from-blue-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-20 px-4 sm:px-6 lg:px-8">
  <div className="max-w-7xl mx-auto">
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      <div className="space-y-8">
        <div className="inline-flex items-center bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-4 py-2 rounded-full text-sm font-semibold">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white">Full-Spectrum Primary & Specialty Care Services</h3>
              <p className="text-gray-600 dark:text-gray-300">From annual physicals and chronic disease management to cardiology consultations and pediatric immunizations</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white">24/7 Online Appointment Booking & Patient Portal Access</h3>
              <p className="text-gray-600 dark:text-gray-300">Schedule visits, view lab results, request prescription refills, and message your care team anytime from any device</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-4">
          ...
          <button className="bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 px-8 py-4 rounded-lg font-semibold text-lg border-2 border-blue-600 dark:border-blue-400 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
            Access Patient Portal
          </button>
        </div>
        
        <div className="flex items-center space-x-6 pt-4 text-sm text-gray-600 dark:text-gray-300">
        ...
        <div className="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 max-w-xs">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300">Patient Satisfaction Rate</div>
            </div>
          </div>
        </div>
      </div>
