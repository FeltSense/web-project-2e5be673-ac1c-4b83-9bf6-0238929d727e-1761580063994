...
export default function Navigation() {
  ...
  // Use mounted state to conditionally render dark mode functionality
  // but always render the navigation structure to prevent hydration mismatch
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            ...
            <button
              ...
              className="ml-4 p-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
          ...
          <div className="md:hidden flex items-center space-x-2">
            ...
            <button
              ...
              className="text-gray-700 dark:text-gray-300 hover:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600 p-2"
            >
